...
for i in range(folds):
    ...
    model = LinearRegressionWithSGD.train(CVTrainData, iterations=10000, step=0.01, miniBatchFraction=0.005, regType='l1', regParam=0.1)
...
test_model = LinearRegressionWithSGD.train(parsed_train_data,iterations=10000, step=0.01, miniBatchFraction=0.005, regType='l1', regParam=0.1)
